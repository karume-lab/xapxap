...
insert into public.fleet_posts (id, author_id, deck_id, parent_id, content, media_url, media_type, checksum, resolution, created_at, updated_at) values
  ('20000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000001', null, 'Wrote a script that edits my clips while I sleep. The future is automated. #tech #gems', 'https://picsum.photos/seed/cyber1/800/1000', 'image/jpeg', 'seed-cyber-1', 720, now() - interval '2 hours', now() - interval '2 hours'),
  ('20000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000001', null, 'Night ride through the city. The lights never miss. #waves #tech', 'https://picsum.photos/seed/neon1/800/1000', 'image/jpeg', 'seed-neon-1', 1080, now() - interval '5 hours', now() - interval '5 hours'),
  ...
  ('20000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000003', '30000000-0000-4000-8000-000000000002', null, 'Made a beat on my phone at the bus stop. Producers, rate it. #music #humor', 'https://picsum.photos/seed/rumz1/800/1000', 'image/jpeg', 'seed-rumz-1', 720, now() - interval '8 hours', now() - interval '8 hours'),
  ('20000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000004', null, 'They said 1 minute of fame was a gimmick. Tell that to my gem count. 💎 #fame #gems', 'https://picsum.photos/seed/kwame1/800/1000', 'image/jpeg', 'seed-kwame-1', 1080, now() - interval '3 hours', now() - interval '3 hours'),
  ('20000000-0000-4000-8000-000000000006', '10000000-0000-4000-8000-000000000005', '30000000-0000-4000-8000-000000000002', null, 'Today on Nyash Chef: 60-second pilau. The whole pot went. #humor #music', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', 'video/mp4', 'seed-nyash-1', null, now() - interval '1 hour', now() - interval '1 hour'),
  ...
  ('20000000-0000-4000-8000-000000000008', '10000000-0000-4000-8000-000000000006', '30000000-0000-4000-8000-000000000004', null, 'Rain drifting practice. 2 wheels, 0 regrets. #waves #gaming', 'https://picsum.photos/seed/drift1/800/1000', 'image/jpeg', 'seed-drift-1', 1080, now() - interval '4 hours', now() - interval '4 hours'),
  ('20000000-0000-4000-8000-000000000009', '10000000-0000-4000-8000-000000000007', '30000000-0000-4000-8000-000000000001', null, 'Just shipped my portfolio site in one weekend. Took me 3 years to finally do it. #tech', 'https://picsum.photos/seed/sahara1/800/1000', 'image/jpeg', 'seed-sahara-1', 720, now() - interval '6 hours', now() - interval '6 hours'),
  ('20000000-0000-4000-8000-000000000010', '10000000-0000-4000-8000-000000000008', '30000000-0000-4000-8000-000000000003', null, 'New speedrun route just dropped. Beat my own record by 0.4s and clipped it for you. #gaming #live', 'https://picsum.photos/seed/pixel1/800/1000', 'image/jpeg', 'seed-pixel-1', 720, now() - interval '7 hours', now() - interval '7 hours'),
  ...
  ('20000000-0000-4000-8000-000000000014', '10000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000004', null, 'Day 1 of wave marathon: 30 waves in 30 days. Your hugs keep me going. #waves #gems', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', 'video/mp4', 'seed-kwame-2', null, now() - interval '20 hours', now() - interval '20 hours')
on conflict (id) do nothing;
